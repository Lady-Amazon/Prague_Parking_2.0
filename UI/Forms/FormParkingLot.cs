...
public partial class FormParkingLot : Form
{
    ...
    public void populateParking(int rowCount, int columnCount, int counter)//Displays the grid for parkinspots. 
    {
    ...
    public void parkingGenerate()
    {
        // Läs settings från jsonfil
        config.ReadFromJson();
        // rowCount = inläst värde / columnCount
        int columnCount = 10;
